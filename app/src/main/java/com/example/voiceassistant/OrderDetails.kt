...
class OrderDetails : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize adapter
        detailsAdapter = OrderDetailsAdapter(emptyList())
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    withContext(Dispatchers.Main) {
                        ...
                        startActivity(Intent(this@OrderDetails, TransactionPage::class.java))
                    }
                } catch (e: Exception) {
                    // Handle exception (e.g., show user feedback)
                    Log.e("OrderDetails", "Error updating payment status", e)
                }
            }
        }
