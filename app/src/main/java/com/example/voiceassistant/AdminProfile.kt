        ...
        withContext(Dispatchers.IO) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    Toast.makeText(this@AdminProfile, "Profile updated", Toast.LENGTH_SHORT).show()
                }
            } catch (e: Exception) {
                Log.e("ProfileActivity", "Error updating user profile", e)
                withContext(Dispatchers.Main) {
                    Toast.makeText(this@AdminProfile, "Error updating profile", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
            ...
            try {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    if (user != null) {
                        ...
                        Toast.makeText(this@AdminProfile, "User not found", Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (e: Exception) {
                Log.e("ProfileActivity", "Error loading user profile", e)
                withContext(Dispatchers.Main) {
                    Toast.makeText(this@AdminProfile, "Error loading user profile", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
